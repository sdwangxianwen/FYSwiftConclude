...
class FYFavoriteButton: UIButton {
    ...
    fileprivate func createLayers(image: UIImage!) {
        ...
        let imageFrame =
            CGRect(x: frame.size.width / 2 - frame.size.width / 4, y: frame.size.height / 2 - frame.size.height / 4, width: frame.size.width / 2, height: frame.size.height / 2)
    ...
    fileprivate func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(FYFavoriteButton.touchDown(_:)), for: UIControl.Event.touchDown)
        self.addTarget(self, action: #selector(FYFavoriteButton.touchUpInside(_:)), for: UIControl.Event.touchUpInside)
        self.addTarget(self, action: #selector(FYFavoriteButton.touchDragExit(_:)), for: UIControl.Event.touchDragExit)
        self.addTarget(self, action: #selector(FYFavoriteButton.touchDragEnter(_:)), for: UIControl.Event.touchDragEnter)
        self.addTarget(self, action: #selector(FYFavoriteButton.touchCancel(_:)), for: UIControl.Event.touchCancel)
    }
    
    @objc func touchDown(_ sender: FYFavoriteButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: FYFavoriteButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: FYFavoriteButton) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: FYFavoriteButton) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: FYFavoriteButton) {
        self.layer.opacity = 1.0
    }
